...
const validator = {
  ...
  isValidPagination(page, pageSize) {
    ...
    return !isNaN(pageNum) && Number.isInteger(pageNum) && pageNum >= 1 &&
           !isNaN(sizeNum) && Number.isInteger(sizeNum) && sizeNum >= 1 && sizeNum <= 100;
  },
