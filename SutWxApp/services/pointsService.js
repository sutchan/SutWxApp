...
class PointsService {
   ...
   * 获取积分记录列表
   * @param {Object} options - 查询参数
   * @param {string} options.type - 记录类型：all/earn/spend
   ...
   * 获取积分兑换记录
   * @param {Object} options - 查询参数
   * @param {string} options.status - 兑换状态：all/pending/shipped/completed/cancelled
   * @param {number} options.page - 页码，默认为1
   * @param {number} options.pageSize - 每页数量，默认为20
   ...
   * 获取积分统计信息
   * @param {Object} options - 查询参数
   * @param {string} options.period - 统计周期：day/week/month/year
   * @param {string} options.startDate - 开始日期
   * @param {string} options.endDate - 结束日期
   ...
   * 获取积分转账记录
   * @param {Object} options - 查询参数
   * @param {string} options.type - 转账类型：all/sent/received
   * @param {number} options.page - 页码，默认为1
   * @param {number} options.pageSize - 每页数量，默认为20
