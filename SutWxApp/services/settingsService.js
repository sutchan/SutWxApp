...
const settingsService = {
   ...
   * @param {string} options.type - 设置类型，可选值：all/app/user/push/privacy/security
   ...
   * @param {string} options.type - 设置类型，可选值：app/user/push/privacy/security
   ...
   * @param {string} options.signature - 个人签名
   * @returns {Promise<Object>} 操作结果
   */
   ...
   * 获取用户协议
   * @param {Object} options - 查询参数
   * @param {string} options.type - 协议类型，可选值：user/privacy
   ...
   * 获取反馈列表
   * @param {Object} options - 查询参数
   * @param {string} options.type - 反馈类型，可选值：all/bug/suggestion/other
   * @param {string} options.status - 反馈状态，可选值：all/pending/processing/resolved
   * @param {number} options.page - 页码，默认为1
   * @param {number} options.pageSize - 每页数量，默认为20
   ...
   * @param {string} options.type - 反馈类型，可选值：bug/suggestion/other
   ...
   * @param {Array} options.types - 清理类型，可选值：images/files/logs/data
   * @returns {Promise<Object>} 操作结果
   */
   ...
   * @param {string} options.type - 重置类型，可选值：all/app/user/push/privacy/security
   * @returns {Promise<Object>} 操作结果
   */
   ...
   * @param {Array} options.types - 导出类型，可选值：profile/orders/favorites/points
   * @param {string} options.format - 导出格式，可选值：json/csv/excel
