...
Page({
  data: {
    ...
    points: 0,
    bannerList: [
      { id: 1, imageUrl: '/images/banner-1.png', link: '/pages/product/detail?id=1' },
      { id: 2, imageUrl: '/images/banner-2.png', link: '/pages/product/detail?id=2' },
      { id: 3, imageUrl: '/images/banner-3.png', link: '/pages/article/detail?id=1' }
    ],
    categoryList: [
  ...
  loadCategories: function() {
    ...
    wx.request({
      ...
      success: function(res) {
        if (res.data && res.data.success) {
          const defaultCategory = { id: 0, name: '全部', icon: '/images/category-all.png' };
    ...
    wx.request({
      ...
      success: function(res) {
        if (res.data && res.data.success) {
          ...
          const newList = that.data.pageNum === 1 ? list : [...that.data.productList, ...list];
          that.setData({
            productList: newList,
            hasMore,
            isLoading: false
