...
class EmptyState extends StatelessWidget {
  ...
  static const Map<EmptyStateType, String> _defaultImages = {
    ...
    EmptyStateType.search: 'assets/images/empty.svg', // 需要替换为对应图片
    EmptyStateType.cart: 'assets/images/empty.svg', // 需要替换为对应图片
    EmptyStateType.order: 'assets/images/empty.svg', // 需要替换为对应图片
  ...
  String get _displayImage {
    return image ?? _defaultImages[type]!;
  }

  /// 获取最终显示的标题
  String get _displayTitle {
    return title ?? _defaultTitles[type]!;
  }

  /// 获取最终显示的描述
  String get _displayDescription {
    return description ?? _defaultDescriptions[type]!;
  }
