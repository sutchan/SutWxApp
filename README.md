...
更新日期: 2025-11-24
作者: Sut
描述: README 文档文件，提供项目概述、安装指南和快速入门信息
-->
# SutWxApp 微信小程序项目
...
- **[开发者指南](docs/03-开发者指南/)** - 开发人员技术文档
- **[用户指南](docs/04-用户指南/)** - 小程序终端用户使用文档
- **[API文档](docs/03-开发者指南/03-API接口文档.md)** - 完整的接口规范和使用示例
- **[功能模块说明](docs/05-功能模块/)** - 各功能模块的详细说明和使用方法
- **[文档指南](docs/01-文档指南/)** - 文档组织方式和维护说明

所有文档均保持版本一致性，当前版本号：1.0.0
...
- 依赖包未正确安装（请尝试删除node_modules并重新运行npm install）
- 代码语法错误（请查看控制台错误信息）
